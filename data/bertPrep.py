...
def main(args):
    ...
    if args.action == 'download':
        ...
        if args.dataset == 'bookscorpus' or 'wikicorpus' in args.dataset or 'books_wiki' in args.dataset or 'wiki_70k' in args.dataset:
            if args.input_files is None:
                ...
                elif args.dataset == 'wiki_70k':
                    args.input_files = [directory_structure['formatted'] + '/wiki_70k_one_article_per_line_'+str(i)+'.txt' for i in range(1,28)]
