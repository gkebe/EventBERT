...
from sklearn.metrics import f1_score, recall_score, precision_score, multilabel_confusion_matrix, classification_report
...
def main():    
    def get_masked_tokens(masked_tensor):
    ...
    with torch.no_grad():
        if args.do_eval:
            ...
            mlm_target_names= [i for i in range(len())]
