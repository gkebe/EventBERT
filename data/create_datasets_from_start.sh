...
awk '{filename = "wiki_70k/step3/wiki_70k_test_with_labels_labels_" int((NR-1)/80000) ".txt"; print >> filename}' wiki_70k/step2/test_with_labels_labels.txt
...
# python3 /workspace/bert/data/eventHdf5.py --max_seq_length 128  \
 # --max_predictions_per_seq 20 --vocab_file $BERT_PREP_WORKING_DIR/download/google_pretrained_weights/uncased_L-12_H-768_A-12/vocab.txt --do_lower_case 1 --n_training_shards 0 --n_test_shards 1 --keep_label True

# python3 /workspace/bert/data/eventHdf5.py --max_seq_length 512  \
 # --max_predictions_per_seq 80 --vocab_file $BERT_PREP_WORKING_DIR/download/google_pretrained_weights/uncased_L-12_H-768_A-12/vocab.txt --do_lower_case 1 --n_training_shards 0 --n_test_shards 1 --keep_label True
