...
class Sharding:
    ...
    def distribute_articles_over_shards(self):
        ...
        assert len(self.articles) >= self.n_training_shards + self.n_test_shards, 'There are fewer articles than shards. Please add more data or reduce the number of shards requested. '+ str(len(self.articles)) + ' articles and ' + str(self.n_training_shards) + ' training shards ' + str(self.n_test_shards) + ' test shards.'
