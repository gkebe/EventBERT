    ...
    for document_index in range(len(all_documents)):
      instances.extend(
          create_instances_from_document(
              all_documents, document_index, max_seq_length, short_seq_prob, max_predictions_per_seq, vocab_words, rng))
...
def main():
    ...
    tokenizer = XLNetTokenizer(args.xlnet_model, do_lower_case=args.do_lower_case, max_len=512)
    ...
    instances = create_training_instances(
        ...
        args.short_seq_prob, args.max_predictions_per_seq,
        rng)
