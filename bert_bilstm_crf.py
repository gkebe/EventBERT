...
class BertPretrainedBiLSTM_CRF(nn.Module):
    def __init__(self,
                 tag_to_idx,
                 hidden_dim,
                 device,
                 pretrained_weights='data/bert_pretrained.pt',
                 tokenizer_class=BertTokenizer,
                 model_class=BertModel,
                 max_seq_len=128):
        super().__init__()
        ...
        self.tokenizer_class = tokenizer_class
        self.model_class = model_class
        self.tokenizer = self.tokenizer_class.from_pretrained("bert-base-uncased")
